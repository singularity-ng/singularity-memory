...
func (f fakeStore) UpsertEntity(_ context.Context, _ string, _ string) (string, error) {
	return "00000000-0000-0000-0000-000000000001", nil
}

func (f fakeStore) LinkUnitEntity(_ context.Context, _ string, _ string) error {
	return nil
}

func (f fakeStore) RecentEntityUnitIDs(_ context.Context, _ string, _ string, _ string, _ int) ([]string, error) {
	return nil, nil
}
...
func (f fakeStore) AppendCoreMemoryBlock(_ context.Context, _ string, _ string, _ string) (*store.CoreMemoryBlock, error) {
	return f.coreBlock, nil
}

func (f fakeStore) ReplaceCoreMemoryBlock(_ context.Context, _ string, _ string, _ string, _ string) (*store.CoreMemoryBlock, error) {
	return f.coreBlock, nil
}

func (f fakeStore) DeleteCoreMemoryBlock(_ context.Context, _ string, _ string) (bool, error) {
	return true, nil
}
