...
This package implements the Model Context Protocol (MCP) JSON-RPC 2.0 HTTP transport for the Operations Memory server.
...
Set `OPS_MEMORY_MCP_AUTH_TOKEN` to require `Authorization: Bearer <token>` on all requests.
